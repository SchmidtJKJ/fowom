...
$SQL="SELECT itilizate.jwetNon, diskisyon.diskisyonID, diskisyon.tit, diskisyon.kontni, diskisyon.dat, diskisyon.met,
diskisyon.repons, diskisyon.likes, diskisyon.dislike, diskisyon.vues
FROM diskisyon
INNER JOIN itilizate
ON diskisyon.met=itilizate.userID
Where diskisyon.kontni LIKE '$mo' OR diskisyon.tit LIKE '%$mo%' ;";
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-md-8">
                          ...
                          <?php if($dsksyn == null){?>
                            <h3> <em>Nou pa jwenn okenn rezilta pou "<?php echo $mo; ?>". Eseye chache yon lòt tèm!</em></h3>
                        <?php  } ?>
                            ...
                            <div class="post">
                                ...
                                <div class="postinfo pull-left">
                                  <form class="" action="yon_diskisyon.php" method="post">

                                    <input type="text" name="gade" value="<?php echo $dsk['diskisyonID'] ?>" style="display:none">
                                    <div class="comments">
                                ...
                                <input type="text" name="diskisyon" style="display:none;" value="<?php echo $dsk['diskisyonID']; ?>">
