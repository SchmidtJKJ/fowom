 ...
 $error = array('imel' =>'' ,'user'=>'' );
   ...
   if(isset($_POST["login"]))
   {
       if(isset($_POST['uname']))
       {
         ...
         {
           header("Location: konekte.php?SQL-Error");
           exit();
         }
         else
         {
           ...
           if($row = mysqli_fetch_assoc($result))
           {
               ...
               $name=$row['imel'];
               $Uid = $row['userID'];
               $rezon = "(IMÈL SA PA RESEVWA REPONS) - Kòd verififikasyon";
               $mesaj = "Men kòd verififikasyon pou w chanje modpas ou a: \r\n\r\n";
               $mesaj .= $kod."\r\nSiw pat mande pou w chanje modpas ou a, efase imèl sa epi kontakte nou pou nou regle sa.";
               $mesaj = wordwrap($mesaj, 70);
               $saveCode = "INSERT INTO verifikasyon (met, token, dat) VALUES ('$Uid','$kod',CURRENT_TIMESTAMP());";
               mail($name, $rezon, $mesaj,'From: enfo@golayiti.com');
               mysqli_query($conn,$saveCode);
               $addPoints="UPDATE itilizate SET patisipasyonPwen= patisipasyonPwen+2 where imel='$name';";
               ...
               $error['user']="imel sa pa anrejistre";
			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-12">
					...
					<div class="ptb-0">
						...
						<a class="mt-10"><i class="mlr-10 ion-chevron-right"></i><b>CHANJE MODPAS</b></a>
		...
		<div class="container">
          ...
          <form action="resetPassword.php" method="POST">
					<div class="p-30 mb-30 card-view">
						...
						<h4 class="p-title"><b>IDANTIFIKASYON</b></h4>
							<div class="row">
								<div class="col-sm-6">
                ...
                <br> &nbsp;
								<div class="col-sm-6">
									<input class="mb-30" type="text" placeholder="non itilizatè w (siw vle)" name="pass">
								</div><!-- col-sm-6 -->
                <br>


							</div><!-- row -->
							<button class="btn-fill-primary plr-20" type="submit" name="login">Chanje modpas</button>
