...
$non = htmlentities($_POST['name']);
$rezon= "Mèsi paske w vle fè pati ekip GolAyiti a";
$headers= "From: GolAyiti <schmidtjkjean@golayiti.com> \r\n";
$headers.="MIME-Version: 1.0"."\r\n";
$headers.= "Content-type:text/html;charset=UTF-8"."\r\n";
$email = "rejwenn.html";
$mesaj = file_get_contents($email);
$mesaj = substr_replace($mesaj, $non,5420,0);
if(mail($imel, $rezon, $mesaj,$headers))
{
  $sent = true;
}
		...
		<div class="container">
          ...
          <form action="" method="POST">
					<div class="p-30 mb-30 card-view">
						...
						<h4 class="p-title"><b>TESTE IMEL</b></h4>
							<div class="row">
								<div class="col-sm-6">
                  <label for="">Non ou</label>
									<input class="mb-30" type="text" name="name" required>

								</div><!-- col-sm-6 -->
                <br> &nbsp;
								<div class="col-sm-6">
                  <label for="">adrès imèl ou</label>
									<input class="mb-30" type="text" placeholder="imel ou" name="email" required>
									</div>
								</div><!-- col-sm-6 -->
                <br>
							...
							<button class="btn-fill-primary plr-20" type="submit" name="test">teste</button>
            </div><!-- row -->
          </form>
        <?php } else {
          echo "Al verifye imèl ou epi wa dim sa w panse! Verifye spam nan tou pou sizoka.";
        } ?>
				</div><!-- col-sm-12 -->
